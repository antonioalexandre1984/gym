...
export function PlanList({ plans }) {
  ...
  return (
    <div className='flex flex-col lg:flex-row items-center justify-center max-w-[1440px] mx-auto gap-y-4'>
                ...
                <div>
                  ...
                  <div
                    className={`${currentIndex === index
                      ...
                      : 'bg-neutral-500 text-white'
                      } h-[26px] font-primary text-sm font-semibold max-w-min mx-auto
                ...
                <div>
                  ...
                  <button
                    className={`${currentIndex === index
                      ? 'bg-white text-neutral-500'
                      : 'bg-neutral-500 text-white'
                      } btn btn-lg rounded-[8px] lg:mx:auto`}
                  >
                    Join Now!
                  </button>
                </div>
